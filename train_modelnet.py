...
import argparse
import sys
from utils.augmentation_transformer import ModelNetAugmentationTransformer
...
parser.add_argument('--k', default=20, help='Number of nearest points [default: 5]')
...
parser.add_argument('--dataset', default='data/ModelNet40', help='Dataset path. [default: data/pantomime]')
parser.add_argument('--num_class', type=int, default=40, help='Number of classes. [default: 21]')
